...
|--------------------------------------------------------------------------
*/
        axios.get('/api/councul_doctors_list')
          .then(res => {
            this.setState({
...
*/
    handlePageChange(pageNumber) {
        ...
        if(this.state.city_id != 0 || this.state.specialization_id != 0){
          ...
          axios.post('/api/councul_doctors_list_search?page='+pageNumber, params, {
        ...
        {
          axios.post('/api/councul_doctors_list_search?page='+pageNumber)
        .then(res => {
          this.setState({
            doctors: res.data.data,
            itemsCountPerPage: res.data.per_page,
...
*/
      searchByCity(){
        ...
        let params = queryString.parse(search_data);
        axios.post('api/councul_doctors_list_search', params, {
        headers: { 'Content-Type': 'application/json' }
        }).then(res => {
            this.setState({
            doctors: res.data.data,
        ...
        <section>
            ...
            <div className="header-text mb-0">
                ...
                <div className="text-center text-white ">
                    ...
                    <li className="breadcrumb-item"><Link to="/free-consultation">مشاوره رایگان</Link></li>
                    </ol>
                </div>
                </div>
            </div>
                ...
                <div className="card mb-0">
                    ...
                    <div className="item2-gl ">
                        ...
                        this.state.doctors.map(doctor=>{
                         if(moment().locale('fa').format('dddd') == doctor.day)
                         {
