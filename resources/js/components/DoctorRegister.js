        ...
        <section>
            ...
            <div className="header-text mb-0">
                ...
                <div className="text-center text-white ">
                    ...
                    <li className="breadcrumb-item"><Link to="/doctor-register">ثبت نام داکتران</Link></li>
                    </ol>
                </div>
                </div>
            </div>
        ...
        <section className="sptb">
            ...
            <div className="row">
                ...
                <div className="card mb-lg-0">				
                    ...
                    <h3 className="card-title">ثبت نام داکتر</h3>
                    </div>
              ...
              <div className="text-center  mt-3 text-dark">
                ...
                <div className="card overflow-hidden">
                    ...
                    <div className="panel-body text-center">
                        <p className="card-category">ثبت منحیث داکتر</p>
                    </div>
                    <ul className="list-group list-group-flush text-center">
                        <li className="list-group-item"><span className="font-weight-semibold">100% رایگان</span></li>
                        <li className="list-group-item"><span className="font-weight-semibold">نمایش پروفایل برای کاربران</span></li>
                        <li className="list-group-item"><span className="font-weight-semibold">نوبت گیری آسان</span></li>
                        <li className="list-group-item"><span className="font-weight-semibold">ایجاد دوسیه به مریضان</span></li>
                        <li className="list-group-item"><span className="font-weight-semibold">ثبت و آدرس دهی معاینه خانه ها</span></li>
                    </ul><br />
                    <h4 className="mb-4 font-weight-semibold">معلومات عمومی</h4>
                    <div className="mb-4">
                        <p>
                        داکتران می توانند پس از ثبت نام و ارائه معتبرین ترین جواز تحصیلی و کاری در سیستم داکترمن فعالیت نموده و تحت یک سیستم متمرکز حرفه ای و با روش های مختلف نوبت دهی آنلاین و تلفنی، نسبت به نوبت دهی به بیماران خود اقدام کنند.
                          </p>
                    </div>
